...
function LoginPage() {
    ...
    const [googleUserInfo, setGoogleUserInfo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [otpAttempts, setOtpAttempts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [otpExpiryTime, setOtpExpiryTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [googleScriptLoaded, setGoogleScriptLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const isInitializedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false) // Cache để tránh init nhiều lần
    ;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginPage.useEffect": ()=>{
            ...
            const initGoogleWhenReady = {
                "LoginPage.useEffect.initGoogleWhenReady": ()=>{
                    ...
                    const checkInterval = setInterval({
                        "LoginPage.useEffect.initGoogleWhenReady.checkInterval": ()=>{
                            checkCount++;
                            if (window.google?.accounts?.id) {
                    ...
                    }["LoginPage.useEffect.initGoogleWhenReady.checkInterval"], 100) // Check mỗi 100ms để init sớm nhất có thể
                    ;
                    return ({
                        "LoginPage.useEffect.initGoogleWhenReady": ()=>clearInterval(checkInterval)
                    })["LoginPage.useEffect.initGoogleWhenReady"];
                }
            }["LoginPage.useEffect.initGoogleWhenReady"];
    ...
    const initializeGoogleSignIn = ()=>{
        if (("TURBOPACK compile-time value", "object") === "undefined" || !window.google?.accounts?.id) return;
        // Tránh init nhiều lần
        if (isInitializedRef.current) return;
        const clientId = ("TURBOPACK compile-time value", "725041606396-9vhqhlr5l3mdvbi41t68asn5ljfgvkus.apps.googleusercontent.com");
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        try {
    ...
    const handleGoogleLoginSubmit = async (googleUserData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/GoogleAuth/login/truong-khoa", {
            ...
            if (response.success && response.token) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authUtils"].setToken(response.token);
    ...
    const handleLogin = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/truong-khoa/auth/login", {
                email: email.trim(),
                password: password.trim()
            });
            if (response.accessToken) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authUtils"].setToken(response.accessToken);
                router.push("/tongquan");
            }
        } catch (err) {
                        ...
                        children: [
                            ...
                            isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    googleScriptLoaded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                otpExpiryTime && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                otpAttempts > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(LoginPage, "ExA/tbMlgFei3a571IoSAUeHCVg=", false, function() {
    return [
...
//# sourceMappingURL=_93f7d7d0._.js.map