...
"[project]/app/giangvien/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GiangVienPage() {
    ...
    const [selectedNganh, setSelectedNganh] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Tất cả ngành");
    const [selectedMon, setSelectedMon] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Tất cả môn");
    const [selectedTrangThai, setSelectedTrangThai] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Tất cả trạng thái");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GiangVienPage.useEffect": ()=>{
            const fetchGiangVien = {
                "GiangVienPage.useEffect.fetchGiangVien": async ()=>{
                    try {
                        setIsLoading(true);
                        ...
                        const giangVienList = Array.isArray(data) && data.length > 0 ? data.map({
                            "GiangVienPage.useEffect.fetchGiangVien": (item)=>({
                                    id: item.id,
                                    ten: item.label,
                                    nganh: "",
                                    monPhuTrach: [],
                        ...
                        }["GiangVienPage.useEffect.fetchGiangVien"]) : [];
                        ...
                        await Promise.allSettled(giangVienList.map({
                            "GiangVienPage.useEffect.fetchGiangVien": async (gv)=>{
                                try {
                                    const lopHocParams = new URLSearchParams();
                                    lopHocParams.append("GiangVienId", gv.id);
                                    const lopHocData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/truong-khoa/options/lop-hoc?${lopHocParams.toString()}`);
                        ...
                        giangVienLopMap.forEach({
                            "GiangVienPage.useEffect.fetchGiangVien": (lopList)=>{
                                lopList.forEach({
                                    "GiangVienPage.useEffect.fetchGiangVien": (lop)=>{
                        ...
                        await Promise.allSettled(lopIdsArray.map({
                            "GiangVienPage.useEffect.fetchGiangVien": async (lopId)=>{
                                try {
                        ...
                        const giangVienWithDetails = giangVienList.map({
                            "GiangVienPage.useEffect.fetchGiangVien.giangVienWithDetails": (gv)=>{
                                const lopHocList = giangVienLopMap.get(gv.id) || [];
                                const nganhSet = new Set();
                                const monHocSet = new Set();
                                lopHocList.forEach({
                                    "GiangVienPage.useEffect.fetchGiangVien.giangVienWithDetails": (lop)=>{
                                ...
                                }["GiangVienPage.useEffect.fetchGiangVien.giangVienWithDetails"]);
                                return {
                                    ...gv,
    ...
    const nganhList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GiangVienPage.useMemo[nganhList]": ()=>{
            const nganhs = new Set();
            giangVienData.forEach({
                "GiangVienPage.useMemo[nganhList]": (gv)=>{
                    if (gv.nganh) {
                        gv.nganh.split(", ").forEach({
                            "GiangVienPage.useMemo[nganhList]": (n)=>nganhs.add(n)
                        }["GiangVienPage.useMemo[nganhList]"]);
                    }
                }
            }["GiangVienPage.useMemo[nganhList]"]);
    ...
    const monHocList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GiangVienPage.useMemo[monHocList]": ()=>{
            const mons = new Set();
            giangVienData.forEach({
                "GiangVienPage.useMemo[monHocList]": (gv)=>{
                    if (Array.isArray(gv.monPhuTrach)) {
                        gv.monPhuTrach.forEach({
                            "GiangVienPage.useMemo[monHocList]": (m)=>mons.add(m)
                        }["GiangVienPage.useMemo[monHocList]"]);
                    }
                }
            }["GiangVienPage.useMemo[monHocList]"]);
    ...
    const filteredData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GiangVienPage.useMemo[filteredData]": ()=>{
            return giangVienData.filter({
                "GiangVienPage.useMemo[filteredData]": (gv)=>{
                    const matchesSearch = searchTerm === "" || (gv.ten || "").toLowerCase().includes(searchTerm.toLowerCase());
                    const matchesNganh = selectedNganh === "Tất cả ngành" || (gv.nganh || "").includes(selectedNganh);
                    const matchesMon = selectedMon === "Tất cả môn" || Array.isArray(gv.monPhuTrach) && gv.monPhuTrach.includes(selectedMon);
                    const matchesTrangThai = selectedTrangThai === "Tất cả trạng thái" || gv.trangThai === selectedTrangThai;
        ...
        children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                children: [
                                    ...
                                    nganhList.map((nganh)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: nganh,
                                            children: nganh
                                        }, nganh, false, {
                                            fileName: "[project]/app/giangvien/page.jsx",
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                children: [
                                    ...
                                    monHocList.map((mon)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: mon,
                                            children: mon
                                        }, mon, false, {
                                            fileName: "[project]/app/giangvien/page.jsx",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    paginatedData.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                            children: isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                ...
                                                lineNumber: 341,
                                                columnNumber: 21
                                            }, this) : paginatedData.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    colSpan: 6,
                                                    className: "py-8 text-center text-gray-500",
                                                    children: "Không tìm thấy giảng viên nào"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/giangvien/page.jsx",
                                                    lineNumber: 348,
                                                    columnNumber: 23
                                                ...
                                                lineNumber: 347,
                                                columnNumber: 21
                                            }, this) : paginatedData.map((gv)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            className: "py-4 px-4 text-sm text-gray-700",
                                                            children: Array.isArray(gv.monPhuTrach) ? gv.monPhuTrach.join(", ") : gv.monPhuTrach || "N/A"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/giangvien/page.jsx",
                                                            lineNumber: 357,
                                                            columnNumber: 25
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: `inline-block px-3 py-1 rounded-full text-xs font-medium ${gv.trangThai === "Hoạt động" ? "bg-green-100 text-green-600" : "bg-red-100 text-red-600"}`,
                                                                children: gv.trangThai || "N/A"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/giangvien/page.jsx",
                                                                lineNumber: 362,
                                                                columnNumber: 27
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            getPageNumbers().map((page, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(GiangVienPage, "CnjApKO7omGqL+2trC+xPGoUKGc=", false, function() {
    return [
...
_c = GiangVienPage;
var _c;
__turbopack_context__.k.register(_c, "GiangVienPage");
...
//# sourceMappingURL=_5e39ca1d._.js.map