...
function Sidebar() {
    ...
    const [unreadCount, setUnreadCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "Sidebar.useState": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                const stored = localStorage.getItem("unreadNotifications");
                return stored ? parseInt(stored) : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["recentNotifications"].filter({
...
_s(Sidebar, "2jNfjABUUftSPhFXUWGJnis29y0=", false, function() {
    return [
...
//# sourceMappingURL=_a3403bdb._.js.map