...
function LichDayPage() {
    ...
    const [isCreateThiModalOpen, setIsCreateThiModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [thiFormData, setThiFormData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        monThi: "",
        lopHoc: "",
        ngayThi: null,
        gioBatDau: "09:00 SA",
    ...
    const [lichDayData, setLichDayData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [lichThiData, setLichThiData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [giangVienData, setGiangVienData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [lopOptions, setLopOptions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [phongOptions, setPhongOptions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const testLopHocAPI = async ()=>{
        try {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get("/api/truong-khoa/options/lop-hoc");
    ...
    const fetchLichDayData = async ()=>{
        try {
            ...
            const allBuoiHocPromises = lopOptions.map(async (lop)=>{
                try {
                    const buoiHocData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/truong-khoa/lop-hoc/${lop.id}/buoi-hoc`);
            ...
            await Promise.allSettled(uniqueLopIds.map(async (lopId)=>{
                try {
                    const lopDetail = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/truong-khoa/lop-hoc/${lopId}`);
    ...
    const fetchLichThiData = async ()=>{
        try {
            ...
            const allBuoiThiPromises = lopOptions.map(async (lop)=>{
                try {
                    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/truong-khoa/lop-hoc/${lop.id}/buoi-thi`);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LichDayPage.useEffect": ()=>{
            const fetchData = {
                "LichDayPage.useEffect.fetchData": async ()=>{
                    try {
                        setIsLoading(true);
                        ...
                        const [giangVienResult, lopResult, phongResult] = await Promise.allSettled([
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get("/api/truong-khoa/options/giang-vien"),
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get("/api/truong-khoa/options/lop-hoc"),
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get("/api/truong-khoa/options/phong-hoc")
                        ]);
                        // Xử lý response - API trả về array trực tiếp hoặc có thể được wrap
                        const extractArray = {
                            "LichDayPage.useEffect.fetchData.extractArray": (result, apiName = "API")=>{
                        ...
                        }["LichDayPage.useEffect.fetchData.extractArray"];
                        ...
                        const mappedLecturers = giangVienArray.map({
                            "LichDayPage.useEffect.fetchData.mappedLecturers": (item)=>({
                                    id: item.id || item.Id || item.giangVienId,
                                    ten: item.label || item.Label || item.ten || item.Ten,
                                    trangThai: "Hoạt động"
                                })
                        }["LichDayPage.useEffect.fetchData.mappedLecturers"]);
                        // Map lớp học - đảm bảo có id, label và mã lớp
                        const mappedLopOptions = lopArray.filter({
                            "LichDayPage.useEffect.fetchData.mappedLopOptions": (item)=>item != null
                        }["LichDayPage.useEffect.fetchData.mappedLopOptions"]) // Lọc bỏ các item null/undefined
                        .map({
                            "LichDayPage.useEffect.fetchData.mappedLopOptions": (item)=>{
                                try {
                        ...
                        }["LichDayPage.useEffect.fetchData.mappedLopOptions"]).filter({
                            "LichDayPage.useEffect.fetchData.mappedLopOptions": (item)=>item != null && item.id != null
                        }["LichDayPage.useEffect.fetchData.mappedLopOptions"]) // Lọc bỏ các item không hợp lệ
                        ;
                        // Map phòng học - đảm bảo có id và label
                        const mappedPhongOptions = phongArray.map({
                            "LichDayPage.useEffect.fetchData.mappedPhongOptions": (item)=>({
                                    id: item.id || item.Id || item.phongHocId,
                                    label: item.label || item.Label || item.tenPhong || item.TenPhong
                                })
                        }["LichDayPage.useEffect.fetchData.mappedPhongOptions"]);
...
Vui lòng kiểm tra backend logs để xem chi tiết lỗi.
            ...
            }["LichDayPage.useEffect.fetchData"];
            fetchData();
        }
    }["LichDayPage.useEffect"], [
        giangVienIdParam
    ...
    const lopList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LichDayPage.useMemo[lopList]": ()=>{
            ...
            return lopOptions.map({
                "LichDayPage.useMemo[lopList]": (lop)=>lop.maLop || lop.label
            }["LichDayPage.useMemo[lopList]"]);
        }
    }["LichDayPage.useMemo[lopList]"], [
        lopOptions
    ...
    const phongList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LichDayPage.useMemo[phongList]": ()=>{
            ...
            const phongsFromDay = lichDayData.map({
                "LichDayPage.useMemo[phongList].phongsFromDay": (lich)=>lich.phongHoc
            }["LichDayPage.useMemo[phongList].phongsFromDay"]);
            const phongsFromThi = lichThiData.map({
                "LichDayPage.useMemo[phongList].phongsFromThi": (lich)=>lich.phongHoc
            }["LichDayPage.useMemo[phongList].phongsFromThi"]);
            const uniquePhongs = [
                ...new Set([
                    ...phongsFromDay,
                    ...phongsFromThi
    ...
    const filteredLichThi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LichDayPage.useMemo[filteredLichThi]": ()=>{
            return lichThiData.filter({
                "LichDayPage.useMemo[filteredLichThi]": (lich)=>{
    ...
    const handleCreateSchedule = async ()=>{
        ...
        try {
            ...
            const userId = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authUtils"].getUserId();
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/truong-khoa/lich-day", requestBody);
    ...
    const handleUpdateSchedule = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].put(`/api/truong-khoa/lich-day/${editingSchedule.id}`, requestBody);
    ...
    const handleCreateThi = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/truong-khoa/lich-thi", requestBody);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        lopOptions.length === 0 && !isLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        giangVienData.map((gv)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                                value: gv.id,
                                                                                children: gv.ten || "N/A"
                                                                            }, gv.id, false, {
                                                                                fileName: "[project]/app/lichday/page.jsx",
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        lopOptions.map((lop)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                                value: lop.maLop,
                                                                                children: lop.maLop
                                                                            }, lop.id, false, {
                                                                                fileName: "[project]/app/lichday/page.jsx",
                                                                ...
                                                                !isLoading && lopOptions.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: (activeTab === "thoikhoabieu" ? filteredLichDay : filteredLichThi).length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                        ...
                                                        children: [
                                                            ...
                                                            phongOptions.map((phong)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                    value: phong.id,
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        lopOptions.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-xs text-red-500 mt-1",
                                            children: "Không thể tải danh sách lớp học."
                                        }, void 0, false, {
                                            fileName: "[project]/app/lichday/page.jsx",
...
_s(LichDayPage, "c2nB5GjmcEpMUK4ODeuCNXsVDBw=", false, function() {
    return [
...
//# sourceMappingURL=_93a9767f._.js.map