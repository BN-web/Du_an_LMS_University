...
const API_BASE_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || "http://localhost:5185";
const apiClient = {
...
function LichDayPage() {
        ...
        "LichDayPage.useEffect": ()=>{
            const fetchData = {
                "LichDayPage.useEffect.fetchData": async ()=>{
                    try {
                        setIsLoading(true);
                        const [giangVienRes, lichDayRes] = await Promise.all([
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get("/api/truong-khoa/giang-vien"),
                            giangVienIdParam ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/truong-khoa/giang-vien/${giangVienIdParam}/lich-day`) : Promise.resolve([])
                        ]);
                        setGiangVienData(Array.isArray(giangVienRes) ? giangVienRes : []);
                        if (Array.isArray(lichDayRes) && lichDayRes.length > 0) {
                            const formattedLichDay = lichDayRes.map({
                                "LichDayPage.useEffect.fetchData.formattedLichDay": (item)=>({
                                        id: item.buoiHocId,
                                        monHoc: item.mon || "",
                                        lop: item.tenLop || "",
                                        ngayDay: item.ngay ? getDayOfWeek(new Date(item.ngay)) : "",
                                        thoiGian: item.gioBatDau && item.gioKetThuc ? `${new Date(item.gioBatDau).toLocaleTimeString("vi-VN", {
                                            hour: "2-digit",
                                            minute: "2-digit"
                                        ...
                                        giangVien: "",
                                        thoiLuong: 0,
                                        ngay: item.ngay ? new Date(item.ngay).toISOString().split("T")[0] : "",
                                        gioBatDau: item.gioBatDau ? new Date(item.gioBatDau).toLocaleTimeString("vi-VN", {
                                            hour: "2-digit",
                                            minute: "2-digit",
                                            hour12: false
                                        }) : "",
                                        gioKetThuc: item.gioKetThuc ? new Date(item.gioKetThuc).toLocaleTimeString("vi-VN", {
                                            hour: "2-digit",
                                            minute: "2-digit",
                                            hour12: false
                                        }) : "",
                                        giangVienId: giangVienIdParam || "",
                                        lopHocId: item.lopHocId,
                                        phongHocId: 0
                                    })
                            }["LichDayPage.useEffect.fetchData.formattedLichDay"]);
                            setLichDayData(formattedLichDay);
                        } else {
                            setLichDayData([]);
                        }
                    } catch (error) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LichDayPage.useEffect": ()=>{
            ...
            const giangVien = giangVienData.find({
    ...
    const handleCreateSchedule = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/truong-khoa/lich-day", {
                lopHocId: parseInt(formData.lopHoc),
                phongHocId: parseInt(formData.phong),
                thoiGianBatDau: thoiGianBatDau.toISOString(),
                thoiGianKetThuc: thoiGianKetThuc.toISOString(),
                giangVienId: formData.giangVienId ? parseInt(formData.giangVienId) : null,
                ghiChu: formData.hinhThucHoc || null,
                overrideConflicts: conflictWarning ? false : false,
                overrideReason: conflictWarning ? "" : null,
                actorNguoiDungId: userId ? parseInt(userId) : null
            });
            ...
            if (giangVienIdParam) {
                const lichDayRes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/truong-khoa/giang-vien/${giangVienIdParam}/lich-day`);
                if (Array.isArray(lichDayRes)) {
                    const formattedLichDay = lichDayRes.map((item)=>({
                            id: item.buoiHocId,
                            monHoc: item.mon || "",
                            lop: item.tenLop || "",
                            ngayDay: item.ngay ? getDayOfWeek(new Date(item.ngay)) : "",
    ...
    const handleUpdateSchedule = async ()=>{
        ...
        try {
            ...
            thoiGianKetThuc.setHours(endTime.hour, endTime.min, 0, 0);
            const userId = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authUtils"].getUserId();
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].put(`/api/truong-khoa/lich-day/${editingSchedule.id}`, {
                phongHocId: parseInt(editFormData.phong),
                thoiGianBatDau: thoiGianBatDau.toISOString(),
                thoiGianKetThuc: thoiGianKetThuc.toISOString(),
                ghiChu: editFormData.hinhThucHoc,
                overrideConflicts: editConflictWarning ? false : false,
                overrideReason: editConflictWarning ? "" : "",
                actorNguoiDungId: userId ? parseInt(userId) : null
            });
    ...
    const handleCreateThi = async ()=>{
        ...
        try {
            ...
            if (!ngayThi) return;
            const userId = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authUtils"].getUserId();
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/truong-khoa/lich-thi", {
                lopHocId: parseInt(thiFormData.lopHoc),
                phongHocId: parseInt(thiFormData.phong),
                ngayThi: ngayThi.toISOString(),
                giamThiId: thiFormData.giamThi ? parseInt(thiFormData.giamThi) : null,
                hinhThuc: thiFormData.hinhThuc,
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        giangVienData.filter((gv)=>gv.trangThai === "Hoạt động").map((gv)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                                value: gv.id,
                                                                                children: gv.ten || "N/A"
                                                                            }, gv.id, false, {
                                                                                fileName: "[project]/app/lichday/page.jsx",
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                            className: "block text-sm font-medium text-gray-700 mb-2",
                                            children: "Giảng viên (ID - tùy chọn)"
                                        }, void 0, false, {
                                            fileName: "[project]/app/lichday/page.jsx",
                                            lineNumber: 889,
                                            columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            placeholder: "Nhập ID giảng viên (để trống nếu tự động phân công)",
                                            className: "w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#4A90D9]"
                                        }, void 0, false, {
                                            fileName: "[project]/app/lichday/page.jsx",
                                            lineNumber: 890,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chevron$2d$left$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ChevronLeft$3e$__["ChevronLeft"], {
                                                    className: "absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 pointer-events-none rotate-[-90deg]"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/lichday/page.jsx",
                                                    lineNumber: 912,
                                                    columnNumber: 17
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                            ...
                                                            onChange: (e)=>{
                                                                ...
                                                                // Chỉ cho phép format như "09:00 AM"
...
_s(LichDayPage, "a6aZTru8+e6tB78XU+fX4crBEbM=", false, function() {
    return [
...
//# sourceMappingURL=_b053690f._.js.map