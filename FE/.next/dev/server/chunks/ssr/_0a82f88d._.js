    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchGiangVien = async ()=>{
            try {
                ...
                const giangVienList = Array.isArray(data) && data.length > 0 ? data.map((item)=>({
                        id: item.id,
                        ten: item.label,
                        nganh: "",
                        monPhuTrach: [],
                ...
                await Promise.allSettled(giangVienList.map(async (gv)=>{
                    try {
                        const lopHocParams = new URLSearchParams();
                        lopHocParams.append("GiangVienId", gv.id);
                        const lopHocData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/truong-khoa/options/lop-hoc?${lopHocParams.toString()}`);
                ...
                await Promise.allSettled(lopIdsArray.map(async (lopId)=>{
                    try {
...
//# sourceMappingURL=_0a82f88d._.js.map